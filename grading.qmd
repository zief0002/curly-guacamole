...
In order to get full credit for the exit ticket you need to be engaged for the entire 75 minutes of class. This means, be on time to class. Be present with your group (do not be surfing the internet or working on other things). Keep your phone and headphones put away during the entire class (see phone policy for more info).

If you miss class for a [University approved reason](https://policy.umn.edu/education/makeupwork), you can make-up the exit ticket for that day by doing three things:

1. Email the instructor as soon as you know you will be missing class.
2. Email your group members so they know you will also be absent.
3. Complete the *entire* class activity that you missed on your own and submit the completed activity to the instructor via email prior to the next class.

If you need additional time, you will need to make  arrangements with the instructor. Whether you will receive an extension is at the discretion of the instructor. For further detail see the [Class Policy for Missing Class and Making up Missed/Late Work](class-policies.html).
<br />
